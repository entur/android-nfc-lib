...
public class Atr210Atr210Reader extends Atr210Reader {

	protected IAtr210ReaderControl readerControl;

	public Atr210Atr210Reader(String deviceId, IAtr210ReaderControl readerControl) {
		this.name = deviceId;
    ...
    public static final Creator<Atr210Atr210Reader> CREATOR = new Creator<Atr210Atr210Reader>() {
        @Override
        public Atr210Atr210Reader createFromParcel(Parcel in) {
            ...
            return new Atr210Atr210Reader(name, iin);
        }

        @Override
        public Atr210Atr210Reader[] newArray(int size) {
            return new Atr210Atr210Reader[size];
        }
    };
