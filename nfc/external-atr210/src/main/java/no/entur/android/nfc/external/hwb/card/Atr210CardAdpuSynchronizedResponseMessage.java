...
public class Atr210CardAdpuSynchronizedResponseMessage extends CardAdpuSynchronizedResponseMessage<UUID> implements DeviceHwbMessage {

    private final ReceiveSchema receive;

    public Atr210CardAdpuSynchronizedResponseMessage(ReceiveSchema receive) {
