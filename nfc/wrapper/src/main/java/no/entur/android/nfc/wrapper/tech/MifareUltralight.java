...
public abstract class MifareUltralight implements BasicTagTechnology {
	 ...
	 * <p>
	 * Returns null if {@link MifareUltralightImpl} was not enumerated in {@link TagImpl#getTechList} - this indicates the tag is not MIFARE Ultralight
	...
	public static MifareUltralight get(Tag tag) {
		if (tag instanceof TagImpl) {
			...
			if (!tagImpl.hasTech(TagTechnology.MIFARE_ULTRALIGHT))
				return null;
			try {
