...
public abstract class Block implements MfBlock {
	...
	public static final int BLOCK_TYPE_VALUE = 0;
	public static final int BLOCK_TYPE_DATA = 1;
	public static final int BLOCK_TYPE_MANU = 2;
	public static final int BLOCK_TYPE_TRAIL = 3;
