...
public class AcrMfUlNTAGReaderWriter implements MfUlReaderWriter {
	...
	public int getMaxPagesPerRead() {
		/*
		 * Remark: The FAST_READ command is able to read out the whole memory with one command. Nevertheless, receive buffer of the NFC device must be able to
		 * handle the requested amount of data as there is no chaining possibility.
		 */
