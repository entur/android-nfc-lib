...
public class ACRReaderTechnology implements ReaderTechnology {
	...
	public ACRReaderTechnology(ACRCommands reader) throws ReaderException {
		...
		/*
		 * dwMaxAPDUDataSize Maximal size of data the reader and its driver can support 0: short APDU only. 0<X<=256: forbidden values (RFU) 256 < X <= 0x10000:
		 * short and extended APDU of up to X bytes of data 0x10000 < X: invalid values (RFU)
		 */
