...
public class Acr1222LReader extends AcrReader {
	...
	public boolean setDefaultLEDAndBuzzerBehaviours(boolean piccPollingStatusLED, boolean piccActivationStatusLED, boolean buzzerForCardInsertionOrRemoval,
	...
	public static final Parcelable.Creator<Acr1222LReader> CREATOR = new Parcelable.Creator<Acr1222LReader>() {
		@Override
