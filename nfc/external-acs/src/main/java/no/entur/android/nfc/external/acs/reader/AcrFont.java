...
public enum AcrFont {
	...
	FONT_A('a', 2, 16, CharacterSets.characterSet0To127, CharacterSets.font1CharacterSet128To255),
	FONT_B('b', 2, 16, CharacterSets.characterSet0To127, CharacterSets.font2CharacterSet128To255),
	FONT_C('c', 4, 16, CharacterSets.characterSet0To127, CharacterSets.font3CharacterSet128To255);
	...
	public byte[] mapString(String string) {
		...
		string: for (int i = 0; i < text.length; i++) {
