...
import no.entur.android.nfc.wrapper.test.tech.MockNdef;
import no.entur.android.nfc.wrapper.test.tech.MockNdefFormatable;
import no.entur.android.nfc.wrapper.test.tech.MockNfcA;
import no.entur.android.nfc.wrapper.test.tech.MockNfcB;
import no.entur.android.nfc.wrapper.test.tech.MockNfcF;
import no.entur.android.nfc.wrapper.test.tech.MockNfcV;
