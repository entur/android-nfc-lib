...
public class HwbMqttService extends Service implements MqttClientConnectedListener, MqttClientDisconnectedListener {
    ...
    protected HwbMqttHandler handler;

    public class LocalBinder extends Binder {
        public HwbMqttService getService() {
            return HwbMqttService.this;
        }
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        LOGGER.info("Starting " + HwbMqttService.class.getName() + " service");
        ...
        if(handler == null) {
            ...
            handler = new HwbMqttHandler(this, mqttServiceClient, transceiveTimeout);
        }
    ...
    public void onConnected(@NotNull MqttClientConnectedContext context) {
        ...
        sendBroadcast(intent, HwbMqttHandler.ANDROID_PERMISSION_NFC);
    ...
    public HwbMqttHandler getHandler() {
        return handler;
    }
